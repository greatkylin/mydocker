    ...
    acx.vector.prototype = {
        ...
        mod: function (fn) { // runs a function against the x and y values
            return new this.Init({
                x: fn.call(this, this.x, "x"),
                y: fn.call(this, this.y, "y")
            });
        },
    ...
    data.MetaDataFactory = ux.Observable.extend({
        ...
        init: function () {
            ...
            this.config.cluster.get("_cluster/state", function (data) {
                this.metaData = new app.data.MetaData({
                    state: data
                });
                this.fire("ready", this.metaData, {
                    originalData: data,
                    "k": 1
                }); // TODO originalData needed for legacy ui.FilterBrowser
            }.bind(this), function () {
                ...
                _cluster.get("_all", function (data) {
                    ...
                    _this.metaData = new app.data.MetaData({
                        state: clusterState
                    });
                    _this.fire("ready", _this.metaData, {
                        originalData: clusterState
                    });
                });
...
(function (app) {
    ...
    data.Query = ux.Observable.extend({
        ...
        _setClause: function (value, field, op, bool) {
            var clause = {},
                query = {};
            if (op === "match_all") {} else if (op === "query_string") {
...
(function (app) {
    ...
    services.ClusterState = ux.Observable.extend({
        ...
        refresh: function () {
            var self = this,
                clusterState, status, nodeStats, clusterNodes, clusterHealth;
    ...
    ui.AbstractPanel = ui.AbstractWidget.extend({
        ...
        close: function () {
            ...
            if (index !== -1) {
                ...
                this.el.css({
                    left: "-2999px"
                }); // move the dialog to the left rather than hiding to prevent ie6 rendering artifacts
                this._setModal();
            ...
            for (var stackPtr = this.shared.stack.length - 1; stackPtr >= 0; stackPtr--) {
                if (this.shared.stack[stackPtr].config.modal) {
                    this.shared.modal
                        ...
                        .css({
                            zIndex: this.shared.stack[stackPtr].el.css("zIndex") - 5
                        })
    ...
    ui.MenuPanel = ui.AbstractPanel.extend({
        ...
        _main_template: function () {
            return {
                tag: "DIV",
                cls: this._baseCls,
                children: this._getItems().map(this._menuItem_template, this)
            };
        },
        _menuItem_template: function (item) {
            var dx = item.disabled ? {
                onclick: function () {}
            } : {};
            return {
                tag: "LI",
...
(function ($, app) {
    ...
    ui.Table = ui.AbstractWidget.extend({
        ...
        _header_template: function (columns) {
            var ret = {
                tag: "TABLE",
                children: [this._headerRow_template(columns)]
            };
...
(function ($, app, joey) {
    ...
    ui.CSVTable = ui.AbstractWidget.extend({
        ...
        _downloadLinkGenerator_handler: function () {
            var csvData = new Blob([this._csvText], {
                type: 'text/csv'
            });
        ...
        pretty: { // from https://github.com/RyanAmos/Pretty-JSON/blob/master/pretty_json.js
            ...
            "object": function (value) {
                ...
                keys.forEach(function (key, i) {
                    ...
                    results.push({
                        tag: "LI",
                        cls: this.expando(value[key]),
                        children: children
                    });
                }, this);
                return ["{ ", ((results.length > 0) ? {
                    tag: "UL",
                    cls: "uiJsonPretty-object",
                    children: results
                } : null), "}"];
            },
...
(function (app) {
    ...
    ui.JsonPanel = ui.InfoPanel.extend({
        ...
        _body_template: function () {
            ...
            body.children = [new ui.JsonPretty({
                obj: this.config.json
            })];
            return body;
        }
    });
    ...
    ui.QueryFilter = ui.AbstractWidget.extend({
        ...
        _openFilter_handler: function (section) {
            ...
            if (!section.loaded) {
                ...
                if (spec.core_type === "string") {
                    ...
                    section.body.append(new ui.DateHistogram({
        ...
        _aliasSelector_template: function () {
            ...
            return {
                ...
                children: [{
                    tag: "SELECT",
                    onChange: this._selectAlias_handler,
                    children: aliases.map(ut.option_template)
                }]
            };
        },
        _indexSelector_template: function () {
            ...
            return {
                ...
                children: [{
                        tag: "HEADER",
                        text: i18n.text("QueryFilter-Header-Indices")
                    },
                    {
                        tag: "DIV",
                        ...
                        children: indices.map(function (name) {
                            return {
                                tag: "DIV",
                                cls: "uiQueryFilter-booble uiQueryFilter-index",
                                text: name
                            };
                        })
                    }
        ...
        _typesSelector_template: function () {
            ...
            return {
                ...
                children: [{
                        tag: "HEADER",
                        text: i18n.text("QueryFilter-Header-Types")
                    },
                    {
                        tag: "DIV",
                        ...
                        children: types.map(function (name) {
                            return {
                                tag: "DIV",
                                cls: "uiQueryFilter-booble uiQueryFilter-type",
                                text: name
                            };
                        })
                    }
        ...
        _filters_template: function () {
            ...
            return {
                ...
                children: [{
                        tag: "HEADER",
                        text: i18n.text("QueryFilter-Header-Fields")
                    },
                    {
                        tag: "DIV",
        ...
        _textFilter_template: function (spec) {
            return {
                ...
                onKeyup: this._textFilterChange_handler
            };
        },
        _dateFilter_template: function (spec) {
            return {
                ...
                children: [{
                        ...
                        onKeyup: this._dateFilterChange_handler
                    },
                    {
                        tag: "PRE",
        ...
        _numericFilter_template: function (spec) {
            return {
                ...
                onKeyup: this._numericFilterChange_handler
            };
        },
        ...
        _multiFieldFilter_template: function (section, spec) {
            return {
                ...
                children: acx.eachMap(spec.fields, function (name, data) {
        ...
        init: function () {
            ...
            new data.MetaDataFactory({
                ...
                onReady: function (metadata) {
                    ...
                    this.store = new data.QueryDataSourceInterface({
                        metadata: metadata,
                        query: this.query
                    });
    ...
    ui.AnyRequest = ui.Page.extend({
        ...
        _request_handler: function (ev) {
            ...
            if (ev) { // if the user click request
                ...
                this.el.find("UL.uiAnyRequest-history")
                    ...
                    .children().find(":last-child").each(function (i, j) {
        ...
        _responseWriter_handler: function (data) {
            ...
            if (this.asJsonEl.attr("checked")) {
                this.outEl.append(new ui.JsonPretty({
                    obj: data
                }));
            }
                                ...
                                body: {
                                    ...
                                    children: [{
                                        ...
                                        },
                                        {
                                            ...
                                            children: [{
                                                tag: "B",
                                                text: i18n.text("AnyRequest.Request")
                                            }],
                                        ...
                                        },
                                        {
                                            ...
                                            children: [{
                                                ...
                                                type: "checkbox",
                                                name: "pretty"
                                            }, i18n.text("AnyRequest.Pretty")]
                                        },
                                        {
                                            tag: "DIV",
                                            cls: "uiAnyRequest-jsonErr"
                                        }
                                    ]
                                }
                            }),
    ...
    ui.NodesView = ui.AbstractWidget.extend({
        ...
        _newAliasAction_handler: function (index) {
            var fields = new app.ux.FieldCollection({
                fields: [
                    new ui.TextField({
                        label: i18n.text("AliasForm.AliasName"),
                        name: "alias",
                        require: true
                    })
                ]
        ...
        _optimizeIndex_handler: function (index) {
            var fields = new app.ux.FieldCollection({
                fields: [
                    ...
                    new ui.CheckField({
                        label: i18n.text("OptimizeForm.FlushAfter"),
                        name: "flush",
                        value: true
                    }),
                    new ui.CheckField({
        ...
        _forceMergeIndex_handler: function (index) {
            var fields = new app.ux.FieldCollection({
                fields: [
                    ...
                    new ui.CheckField({
                        label: i18n.text("ForceMergeForm.FlushAfter"),
                        name: "flush",
                        value: true
                    })
                ]
        ...
        _routing_template: function (routing) {
            var cell = {
                tag: "TD",
                cls: "uiNodesView-routing" + (routing.open ? "" : " close"),
                children: []
            };
                    ...
                    this._nodeIcon_template(node),
                    {
                        ...
                        children: node.name === "Unassigned" ? [{
                            ...
                            text: node.name
                                ...
                                tag: "H3",
                                text: node.cluster.name
                            },
                            {
                                tag: "DIV",
                                text: node.cluster.hostname
                            },
                        ...
                        menu: new ui.MenuPanel({
                            items: [{
                                ...
                                },
                                {
                                    ...
                                    onclick: this.cluster.versionAtLeast("5.0.0.") ? function () {
            ...
            return cluster.aliases.length && {
                ...
                children: [{
                    ...
                    children: [{
                        ...
                        return {
                            tag: "TD",
                            children: index.metadata && index.metadata.aliases.map(function (alias) {
                                return {
                                    tag: "LI",
                                    text: alias
                                };
                ...
                children: cluster.aliases.map(function (alias, row) {
                    return {
                        ...
                        children: [{
                            ...
                            tag: "TD"
                        }].concat(alias.indices.map(function (index, i) {
                            if (index) {
                                return {
                                    tag: "TD",
                                    css: {
            ...
            return {
                ...
                children: [
                    this._styleSheetEl,
                    {
                        ...
                        children: [{
                            tag: "TR",
                            children: indices.map(this._indexHeader_template, this)
                        }]
                    },
                    this._aliasRenderFunction(cluster, indices),
                    {
                        tag: "TBODY",
                        children: cluster.nodes.map(this._node_template, this)
                    }
                ]
            };
        }
    ...
    ui.ClusterOverview = ui.Page.extend({
        ...
        init: function () {
            ...
            this._indicesSortMenu = new ui.MenuButton({
                ...
                menu: new ui.SelectMenuPanel({
                    ...
                    items: [{
                            value: "desc",
                            text: i18n.text("SortIndices.Descending")
                        },
                        {
                            value: "asc",
                            text: i18n.text("SortIndices.Ascending")
                        }
                    ],
                    onSelect: function (panel, event) {
            ...
            this._aliasMenu = new ui.MenuButton({
                ...
                menu: new ui.SelectMenuPanel({
                    ...
                    items: [{
                            value: "full",
                            text: i18n.text("ViewAliases.Grouped")
                        },
                        {
                            value: "list",
                            text: i18n.text("ViewAliases.List")
                        },
                        {
                            value: "none",
                            text: i18n.text("ViewAliases.None")
                        }
                    ],
                    onSelect: function (panel, event) {
        ...
        draw_handler: function () {
            ...
            nodes.forEach(function (node) {
                ...
                for (var i = 0; i < indices.length; i++) {
                    node.routings[i] = node.routings[i] || {
                        name: indices[i].name,
                        replicas: []
                    };
            ...
            $.each(clusterState.metadata.indices, function (name, index) {
                index.aliases.forEach(function (alias) {
                    var aliasIndex = aliasesIndex[alias] = (alias in aliasesIndex) ? aliasesIndex[alias] : aliases.push({
                        name: alias,
                        max: -1,
                        min: 999,
                        indices: [].concat(indexClone)
                    }) - 1;
            ...
            return {
                ...
                children: [{
                    ...
                    },
                    {
                        tag: "BUTTON",
                        type: "button",
                        text: i18n.text("Header.Connect"),
                        onclick: this._reconnect_handler
                    }
                ]
            };
        }
...
(function ($, app, i18n) {
    ...
    var StructuredQuery = ui.AbstractWidget.extend({
        ...
        _jsonResults_handler: function (results) {
            this.el.find("DIV.uiStructuredQuery-out").empty().append(new ui.JsonPretty({
                obj: results
            }));
        },
        _csvResults_handler: function (results) {
            this.el.find("DIV.uiStructuredQuery-out").empty().append(new ui.CSVTable({
                results: results
            }));
        },
        _tableResults_handler: function (results, metadata) {
            ...
            var qdi = new data.QueryDataSourceInterface({
                metadata: metadata,
        ...
        _searchSource_handler: function (src) {
            ...
            searchSourceDiv.empty().append(new app.ui.JsonPretty({
                obj: src
            }));
        ...
        _main_template: function () {
            return {
                ...
                children: [
                    ...
                    {
                        tag: "DIV",
                        cls: "uiStructuredQuery-body"
                    },
                    {
                        tag: "DIV",
                        cls: "uiStructuredQuery-src",
                        css: {
                            display: "none"
                        }
                    },
...
(function ($, app, i18n) {
    ...
    ui.FilterBrowser = ui.AbstractWidget.extend({
        ...
        _changeQueryField_handler: function (jEv) {
            ...
            var ops = [];
            if (spec.type === 'match_all') {} else if (spec.type === '_all') {
                ops = ["query_string"];
                ...
                children: [{
                    ...
                    },
                    {
                        ...
                        children: i18n.complex("FilterBrowser.OutputType", {
                            ...
                            children: [{
                                    text: i18n.text("Output.Table"),
                                    value: "table"
                                },
                                {
                                    text: i18n.text("Output.JSON"),
                                    value: "json"
                                },
                                {
                                    text: i18n.text("Output.CSV"),
                                    value: "csv"
                                }
                            ].map(function (o) {
                                return $.extend({
                    ...
                    },
                    {
                        ...
                        children: [{
                            tag: "INPUT",
                            type: "checkbox",
                            cls: "uiFilterBrowser-showSrc"
                        }, i18n.text("Output.ShowSource")]
                    }
                ]
            };
        },
        ...
        _filter_template: function () {
            return {
                ...
                children: [{
                        tag: "SELECT",
                        cls: "bool",
                        children: ["must", "must_not", "should"].map(ut.option_template)
                    },
                    {
                        tag: "SELECT",
                        cls: "field",
                    ...
                    },
                    {
                        ...
                        type: "button",
                        text: "+",
                        onclick: this._addFilterRow_handler
                    },
                    {
                        tag: "BUTTON",
                        type: "button",
                        text: "-",
                        onclick: this._removeFilterRow_handler
                    }
                ]
            };
        },
        ...
        _range_template: function () {
            return {
                ...
                children: [{
                        tag: "SELECT",
                        cls: "lowop",
                        children: ["gt", "gte"].map(ut.option_template)
                    },
                    {
                        tag: "INPUT",
                        type: "text",
                    ...
                    },
                    {
                        tag: "SELECT",
                        cls: "highop",
                        children: ["lt", "lte"].map(ut.option_template)
                    },
                    {
                        tag: "INPUT",
                        type: "text",
    ...
    ui.IndexSelector = ui.AbstractWidget.extend({
        ...
        _select_template: function (options) {
            return {
                tag: "SELECT",
                children: options,
                onChange: this._indexChanged_handler
            };
        },
...
(function ($, app, i18n) {
    ...
    ui.Header = ui.AbstractWidget.extend({
        ...
        init: function () {
            ...
            var quicks = [{
                    text: i18n.text("Nav.Info"),
                    path: ""
                },
                {
                    text: i18n.text("Nav.Status"),
                    path: "_stats"
                },
                {
                    text: i18n.text("Nav.NodeStats"),
                    path: "_nodes/stats"
                },
                {
                    text: i18n.text("Nav.ClusterNodes"),
                    path: "_nodes"
                },
                {
                    text: i18n.text("Nav.Plugins"),
                    path: "_nodes/plugins"
                },
                {
                    text: i18n.text("Nav.ClusterState"),
                    path: "_cluster/state"
                },
                {
                    text: i18n.text("Nav.ClusterHealth"),
                    path: "_cluster/health"
                },
                {
                    text: i18n.text("Nav.Templates"),
                    path: "_template"
                }
            ];
        ...
        _main_template: function () {
            return ({
                ...
                children: [
                    ...
                    {
                        tag: "H1",
                        text: i18n.text("General.Elasticsearch")
                    },
                    {
                        tag: "SPAN",
                        cls: "pull-right",
    ...
    ui.IndexOverview = ui.Page.extend({
        ...
        _newIndex_handler: function () {
            var fields = new app.ux.FieldCollection({
                fields: [
                    new ui.TextField({
                        label: i18n.text("ClusterOverView.IndexName"),
                        name: "_name",
                        require: true
                    }),
                    new ui.TextField({
            ...
            var dialog = new ui.DialogPanel({
                ...
                onCommit: function (panel, args) {
                    if (fields.validate()) {
                        ...
                        var name = data["_name"];
                        delete data["_name"];
                        this.config.cluster.put(encodeURIComponent(name), JSON.stringify({
                            settings: {
                                index: data
                            }
                        }), function (d) {
            ...
            return ({
                ...
                children: [{
                    ...
                    },
                    {
                        tag: "TBODY",
                        cls: "striped",
                        children: view.indices.map(this._index_template, this)
                    }
                ]
            });
        },
        ...
        _index_template: function (index) {
            return ({
                ...
                children: [{
                    ...
                    {
                        tag: "TD",
                        text: ut.count_template(index.state.primaries.docs.count)
                    }
                ]
            });
        },
        _main_template: function () {
            return {
                ...
                children: [
                    ...
                    {
                        tag: "DIV",
                        cls: "uiIndexOverview-table",
                        children: this._indexViewEl
                    }
                ]
            };
        }
...
(function (app, i18n) {
    ...
    app.App = ui.AbstractWidget.extend({
        ...
        init: function (parent) {
            this._super();
            this.prefs = services.Preferences.instance();
            this.base_uri = this.config.base_uri || this.prefs.get("app-base_uri") || "http://10.0.91.18:9200";
            ...
            this.cluster = new services.Cluster({
            ...
            this._header = new ui.Header({
                cluster: this.cluster,
                clusterState: this._clusterState
            });
        ...
        _openAnyRequest_handler: function (ev) {
            this.navigateTo("AnyRequest", {
                cluster: this.cluster
            }, ev);
        },
        _openStructuredQuery_handler: function (ev) {
            this.navigateTo("StructuredQuery", {
                cluster: this.cluster
            }, ev);
        },
        ...
        _openClusterOverview_handler: function (ev) {
            this.navigateTo("ClusterOverview", {
                cluster: this.cluster,
                clusterState: this._clusterState
            }, ev);
        },
        _openIndexOverview_handler: function (ev) {
            this.navigateTo("IndexOverview", {
                cluster: this.cluster,
                clusterState: this._clusterState
            }, ev);
        },
